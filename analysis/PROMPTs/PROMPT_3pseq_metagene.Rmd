...
meta_log2FCs3 %>%
  ...
  #geom_ribbon(aes(ymin=conf.low, ymax=conf.high, fill=class3), alpha=.2)  +
  facet_grid(fraction+PAP~class3, scales='free')  +
  ylab('Average Log2 Signal') +
  areaplot_style
```
...
meta_log2FCs4 %>%
  ...
  geom_line(aes(x=rel_pos, y=estimate, color=siRNA)) +
  #geom_ribbon(aes(ymin=conf.low, ymax=conf.high, fill=class3), alpha=.2)  +
  facet_grid(fraction+PAP~class4, scales='free')  +
  ylab('Average Log2 Signal') +
  areaplot_style
```
...
meta_log2FCs5 %>%
  ...
  geom_line(aes(x=rel_pos, y=estimate, color=siRNA)) +
  #geom_ribbon(aes(ymin=conf.low, ymax=conf.high, fill=class3), alpha=.2)  +
  facet_grid(fraction+PAP~class5, scales='free')  +
  ylab('Average Log2 Signal') +
  areaplot_style
```
...
meta_log2FCs3 %>%
  ...
  facet_grid(fraction+PAP~class3+siRNA, scales='free')  +
  ylab('Average Log2 Signal') +
  lineplot_style
```
...
meta_log2FCs5 %>%
  ...
  geom_line(aes(color=class5)) +
  geom_ribbon(aes(ymin=conf.low, ymax=conf.high, fill=class5), alpha=.2)  +
  facet_grid(fraction+PAP~siRNA+hexamer, scales='free')  +
  ylab('Average Log2 Signal') +
  lineplot_style
```
